        ...
        <div class="container">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><img src="assets/img/logo.jpg" alt="Logo">
                    </a>
                </div>
            ...
            <div class="header-content row">
				...
				<div id="owl-demo" class="owl-carousel header1">
				  ...
				  <div class="col-xs-12 col-sm-6 col-md-6 header-text">
                    <h2 class="wow bounceIn animated" data-wow-delay=".40s">냥뇽녕냥 <span>덕질하는 </span>사이트 </h2>
                    <h3 class="wow bounceIn animated" data-wow-delay=".50s">가장 먼저 냥뇽녕냥이란? </h3>
                    <p class="wow bounceIn animated" data-wow-delay=".60s">이름: 냥뇽녕냥(히나) 나이: 21세(2021년기준) <br>특징: 아름답고 귀엽다 활동: 틱톡 인스타 페북</p>
                    <p>
				 ...
				 <div>
				  <div class="col-xs-12 col-sm-6 col-md-6 header-text">
                    <h2 class="wow bounceIn animated" data-wow-delay=".40s">당신은 <span>냥뇽녕냥의</span> 팬인가요? </h2>
                    <h3 class="wow bounceIn animated" data-wow-delay=".50s">당신이 진정한 팬이라면 알아야 할것들 </h3>
                    <p class="wow bounceIn animated" data-wow-delay=".60s">가장 먼저 도용 혹은 불펌은 덕질이 아닙니다. 그다음으로 카톡방도 있으니 이점 참고해주세요.</p>
                    <p>
                        <div class="btn btn-primary btn-lg btn-ornge wow bounceIn animated" data-wow-delay="1s"><i class="hbtn"></i> <span>Click Here</span></i>
                        </div>
                    </p>
        ...
        <div class="container">            
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 wow fadeInDown animated" data-wow-delay=".5s">
                   <h2>냥뇽녕냥</h2>
				   <p>틱톡 첫영상은 2019년 10월 16일(현재 삭제)이지만 본격적으로 시작한건 2020년 08월 13일부터이다.  </p>
				   <p>코스프레를 자주하며 코스프레후 영상 혹은 사진을 페북 인스타 틱톡에 올린다.</p>
				   <p>예쁘고 귀엽고 게임마저 좋아하는 만인의 이상형이다.</p>
                  </div>
...
<!-- =============== link =============== -->
    <section id="link" class="wow flipInX animated" data-wow-delay=".5s">
	<div class="title">
				<h2>link</h2>				
				<p>Hina's collection of links.</p>
    </div>
  <div class="grid baguetteBoxThree link">
      <div class="element-item transition webdesign " data-category="post-transition">
	  <a href="https://www.instagram.com/i_am_young22/">	 
	  <img src="assets/img/gallery/instagram.jpg"/>      
		<div class="hover-img"> 
		<h2>Instagram</h2>
	  ...
	  <a href="https://www.tiktok.com/@i_am_young22">	 
        <img src="assets/img/gallery/tiktok.jpg"/>    
		<div class="hover-img"> 
		<h2>TikTok</h2>
	  ...
	  <a href="https://www.facebook.com/profile.php?id=100008921590290">	 
		<img src="assets/img/gallery/facebook.jpg"/>       
		<div class="hover-img"> 
		<h2>Facebook</h2>
		</div>		
		</a>
